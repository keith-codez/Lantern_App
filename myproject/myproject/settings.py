...
STATIC_URL = 'static/'
#STATICFILES_DIRS = (os.path.join(BASE_DIR, "contact/static"),) must only be used when static folder is in root not app 
# The path to your static files
STATIC_ROOT =  BASE_DIR/'static' # The absolute path to the directory where collectstatic will collect static files for deployment.
MEDIA_URL = "img/"
